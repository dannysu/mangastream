    ...
    public sealed class InvokeDelegateCommandAction : TriggerAction<DependencyObject>
    {
        ...
        private ICommand ResolveCommand()
        {
            ...
            if (frameworkElement != null)
            {
                ...
                if (dataContext != null)
                {
                    PropertyInfo[] properties = dataContext.GetType().GetProperties(BindingFlags.Public | BindingFlags.Instance);
                    PropertyInfo commandPropertyInfo = null;
